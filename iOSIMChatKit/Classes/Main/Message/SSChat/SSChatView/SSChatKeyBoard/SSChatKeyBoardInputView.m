...
- (instancetype)init
{
    if(self = [super init]) {
        ...
        self.frame = CGRectMake(0, SCREEN_Height-SSChatKeyBoardInputViewH-SafeAreaTop_Height-SafeAreaBottom_Height, SCREEN_Width, SSChatKeyBoardInputViewH);
    ...
    [UIView animateWithDuration:_changeTime animations:^{
        if(self.keyBoardStatus == SSChatKeyBoardStatusDefault ||
           self.keyBoardStatus == SSChatKeyBoardStatusVoice){
            self.bottom = SCREEN_Height-SafeAreaTop_Height-SafeAreaBottom_Height;
        }else{
            self.bottom = SCREEN_Height-SafeAreaTop_Height-self.keyBoardHieght;
        }
    } completion:nil];
}
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        if(self.keyBoardStatus == SSChatKeyBoardStatusDefault ||
           self.keyBoardStatus == SSChatKeyBoardStatusVoice){
            ...
            self.bottom = SCREEN_Height-self.keyBoardHieght - SafeAreaTop_Height;
        }

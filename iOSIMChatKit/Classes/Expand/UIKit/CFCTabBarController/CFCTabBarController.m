                   ...
                   tabBarItemEnabled:(BOOL)enabled
{
    ...
    if (enabled) {
        ...
        naviViewController.tabBarItem.titlePositionAdjustment = UIOffsetMake(0, -1);
        ...
        naviViewController.tabBarItem.image = [[UIImage imageNamed:normalImageName] imageByScalingProportionallyToSize:imageSize];
        naviViewController.tabBarItem.selectedImage = [[UIImage imageNamed:selectImageName] imageByScalingProportionallyToSize:imageSize];
    } else {

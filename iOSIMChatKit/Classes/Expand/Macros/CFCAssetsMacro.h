...
#define ICON_TAB_BAR_ITEM_MESSAGE_NORMAL                            @"icon_tabbar_item_message"
#define ICON_TAB_BAR_ITEM_MESSAGE_SELECT                            @"icon_tabbar_item_message_select"
#define ICON_TAB_BAR_ITEM_CONTACT_NORMAL                            @"icon_tabbar_item_contact"
#define ICON_TAB_BAR_ITEM_CONTACT_SELECT                            @"icon_tabbar_item_contact_select"
#define ICON_TAB_BAR_ITEM_MINE_NORMAL                               @"icon_tabbar_item_mine"
#define ICON_TAB_BAR_ITEM_MINE_SELECT                               @"icon_tabbar_item_mine_select"

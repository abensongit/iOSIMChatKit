...
#pragma mark -
#pragma mark 常用的宏常量
#define NOTIFICATION_DEF_CENTER  [NSNotificationCenter defaultCenter]
...
#define COLOR_NAVIGATION_BAR_TITLE_DEFAULT                        COLOR_HEXSTRING(@"#000000")
...
#define COLOR_TAB_BAR_TITLE_SELECT_DEFAULT                        COLOR_HEXSTRING(@"#007AFF")
